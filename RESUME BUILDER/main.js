...
const ResumePhoto = document.getElementById("profile_image");
const MyName = document.getElementById("MyName");
const Title = document.getElementById("Title");
const MobileNo = document.getElementsByClassName("Text")[0];
const Email = document.getElementsByClassName("Text")[1];
const Website = document.getElementsByClassName("Text")[2];
const Linkedin = document.getElementsByClassName("Text")[3];
const Github = document.getElementsByClassName("Text")[4];
const Address = document.getElementsByClassName("Text")[5];
const Download = document.getElementById("Download-btn");
const Edit = document.getElementById("edit");
// output
const CvPhoto = document.getElementById("Image");
ResumeForm.addEventListener("submit", async (event) => {
    ...
    const profession = document.getElementById("profession")
        .value;
    const mobileno = document.getElementsByClassName("input_info")[0].value;
    const email = document.getElementsByClassName("input_info")[1].value;
    const website = document.getElementsByClassName("input_info")[2].value;
    const linkedin = document.getElementsByClassName("input_info")[3].value;
    const github = document.getElementsByClassName("input_info")[4].value;
    const address = document.getElementsByClassName("input_info")[5].value;
    console.log(myname);
    if (MyName)
...
function displayEducationOnResume() {
    const resumeEducationContainer = document.getElementById("resume-education-container");
    if (!resumeEducationContainer)
        return;
...
function displayJobOnResume() {
    ...
    for (let i = 1; i <= jobCount; i++) {
        ...
        const company = document.getElementById(`company-${i}`)?.value ||
            "";
        const workingYears = document.getElementById(`workingYears-${i}`)
            ?.value || "";
        const jobdetails = document.getElementById(`jobdetails-${i}`)?.value ||
            "";
        const para = document.getElementById(`jobdetails-${i}`)?.value ||
            "";
...
const ResumePage = document.getElementsByClassName("ResumePage")[0];
...
function displayHobbyOnResume() {
    const resumeHobbyContainer = document.getElementById("resume-hobby-container");
    if (!resumeHobbyContainer)
        return;
    // Clear existing education data in the resume section
    resumeHobbyContainer.innerHTML = "";
    // Loop through and display each added education entry
    for (let i = 1; i <= hobbyCount; i++) {
        const hobbies = document.getElementById(`hobbylist-${i}`)?.value ||
            "";
        if (hobbies) {
...
function displaySkillsOnResume() {
    const resumeSkillContainer = document.getElementById("resume-skill-container");
    if (!resumeSkillContainer)
        return;
    ...
    for (let i = 1; i <= skillCount; i++) {
        ...
        const skillLevelInput = document.getElementById(`skill-level-${i}`);
