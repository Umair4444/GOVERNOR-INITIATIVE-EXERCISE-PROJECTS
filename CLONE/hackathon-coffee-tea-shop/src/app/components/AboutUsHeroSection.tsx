...
import image1 from "@/app/assets/choose1.png";
import image2 from "@/app/assets/choose2.png";
import image3 from "@/app/assets/choose3.png";
import play from "@/app/assets/logo/Play.png";
    ...
    <div className="grid grid-flow-row lg:grid-flow-col lg:justify-items-end w-screen gap-10 sm:px-4 md:px-8 lg:px-16 lg:justify-around text-black">
      ...
      <div className="w-full flex flex-col justify-center gap-6">
        ...
        <div className="flex flex-wrap items-center gap-4">
          <Button title="Show More" rounded="rounded-lg" />
