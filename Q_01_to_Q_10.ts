let person_name: string = "Umair Ali Khan";

console.log(
  "hello",
  person_name,
  "How are you doing and great experience learning programming"
);
...
let my_name: string = "UmAir AlI KhAn";
...
console.log(
  `Thomas Edison once said, "I not only discovered a way to light a bulb but rather discovered 100 ways on how not to light a bulb"`
);
...
let person_Name_With_Whitespace: string = "\t       John Doe         \t\n ";

// Print the name with whitespace
console.log("Name with whitespace:", person_Name_With_Whitespace);

// Strip whitespace from the name
let strippedName: string = person_Name_With_Whitespace.trim();
...
let private_messsage: string = `my favourite number is ${fav_num}`;
