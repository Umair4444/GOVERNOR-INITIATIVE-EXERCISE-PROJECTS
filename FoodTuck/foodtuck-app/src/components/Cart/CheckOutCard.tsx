...
import { useState } from "react"; // Add this to manage state for total
import StripePayment from "@/components/Cart/StripePayment"; // Import StripePayment
...
const CheckOutCard = () => {
  ...
  return (
    <div className="bg-white text-black mt-20 border-2 flex flex-col mx-2 pb-2 rounded-md">
      ...
      {/* Show Stripe Payment if checkout is triggered */}
      {isCheckout && <StripePayment amount={totalAmount} />}
    </div>
  );
};
